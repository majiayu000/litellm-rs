...
- `base/sse.rs`、公开 direct/Vertex provider stream 与 standard
  ...
  residual buffer；公开序列化不得携带 marker/伪零 usage，Invalid 后 settlement
  不得复用旧 Valid。
