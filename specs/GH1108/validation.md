...
| `live_observation_canonicalization` | `tests/live_gemini.rs` | `fn:canonicalize_live_observation` |
| `live_interruption_persistence` | `tests/live_gemini.rs` | `async_body:run_live_gemini_smoke` |
