...
`codestral`, `custom_api`, `deepgram`, `elevenlabs`, `huggingface`, `jina`, `milvus`, `oci`, `ollama`, `pg_vector`, `recraft`, `runwayml`, `sagemaker`, `searxng`, `snowflake`, `stability`, `tavily`, `voyage`, `watsonx`
